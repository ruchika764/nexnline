	...
	<body>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">Serving</li>
							</ol>
						</div>
					</div>
				</div>
								...
								<div class="card-header p-3">
									<div class="row align-items-center">
										...
										<div class="col-6 text-end">
											<a class="btn-action btn-nav" data-bs-toggle="modal" data-bs-target="#waitlistModal">Add New</a>
										</div>
									</div>
								</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">Serve Client</h5>
		...
		<div class="modal fade" id="editwaitlistModal" tabindex="-1" aria-labelledby="waitlistModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">Edit John Smith</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<div class="modal-body">
						<div class="row">
				...
				<div class="modal-content"  id="abc">
					<div class="modal-header">
						<div class="modal-inner">
							<h5 class="modal-title" id="exampleModalLabel">John Smith</h5>
							<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
						</div>
							...
							<div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
								<div class="form-group detailmain">
									<div class="d-flex justify-content-between">
										...
										<span class="detail-left label label-success">Confirmed</span>
									</div>
								</div>
								<div class="form-group detailmain">
									<div class="d-flex justify-content-between">
										<span class="detail-left">Served</span>
										<span class="detail-right">1 day</span>
									</div>
								</div>
								<div class="form-group detailmain">
									<div class="d-flex justify-content-between">
										<span class="detail-left">Phone</span>
										<span class="detail-right">081247 56565</span>
									</div>
								</div>
								<div class="form-group detailmain">
									<div class="d-flex justify-content-between">
										...
										<div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne" data-bs-parent="#accordionExample">
											<div class="accordion-body">
												...
												<div class="form-group detailmain">
													<div class="d-flex justify-content-between">
														<span class="detail-left">Status</span>
														<span class="detail-right"><span class="label label-success">Confirmed</span></span>
													</div>
												</div>
												<div class="form-group detailmain">
													<div class="d-flex justify-content-between">
												...
												<div class="form-group detailmain">
													<div class="d-flex justify-content-between">
														<span class="detail-left">Staff</span>
														<span class="detail-right">Sally</span>
													</div>
												</div>
												<div class="form-group detailmain">
													<div class="d-flex justify-content-between">
												...
												<div class="form-group detailmain">
													<div class="d-flex justify-content-between">
														...
														<span class="detail-right">0 min</span>
													</div>
												</div>
												<div class="form-group detailmain">
													<div class="d-flex justify-content-between">
