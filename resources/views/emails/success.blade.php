            ...
            <table style="-premailer-cellpadding: 0;-premailer-cellspacing: 0;-premailer-width: 100%;margin: 0;padding: 0;width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
              <tr>
                <td style="padding: 25px 0;text-align: center;">
                    <a href="#" style="display: inline-block; color: #3d4852;font-size: 19px;font-weight: bold;text-decoration: none;">
                        <img src="http://dev.indiit.solutions/eventa_dev/public/assets/admin/images/small-logo.png" style="height: 35px;object-fit:contain;">
                    </a>
                </td>
            </tr>
                                                    ...
                                                    <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;" align="left">
                                                        <div style="cursor:auto;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:16px;line-height:24px;text-align:left;">
                                                           ...
                                                           <div class="main-header" style="text-align:center;margin-bottom: 40px;">
                                                              <div class="head-img">
                                                                  <img src="buy.png" style="max-width: 150px;max-height: 200px;width: auto;height: 150px;margin:0 auto 15px;">
                                                              </div>
                                                              <h1 style="text-align:center;color: #0a003a; margin-bottom: 0px;font-size: 35px;margin-top:0px;">Successfully Register<br><br><span style="color: black;font-size: 20px;">  Hi {{$username}} , you successfully registered on nexnline.</span>
                                                              </h1>
                                                        ...
                                                        <div class="main-footer" style="display:flex;align-items: center;">
                                                           <span style="width: 50%;">
                                                            <p style="font-weight: 400;color: grey;font-size: 13px;    line-height: 12px;margin-bottom: 0px;margin-top: 0px;">© Copyright 2021, United State
                                                             </p>
                                                         </span>
